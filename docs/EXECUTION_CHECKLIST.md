...
- [x] login
- [x] refresh
- [x] JWT middleware (HMAC-signed token validation)
- [x] RBAC middleware (admin route protection)
...
- [x] Executed next 5 steps: JWT auth, RBAC, and API metrics (points/login_failures/playback_errors).
